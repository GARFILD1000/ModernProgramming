...
fun main(args: Array<String>) {
    ...
    val number = TPNumber("-A.1",NumberBase.SIXTEEN,10)
    ...
    println("\n")
    var number2 = TPNumber("1.01",NumberBase.TEN,10)
    var number3 = TPNumber("10.01",NumberBase.TEN,10)
    number2 += number3
