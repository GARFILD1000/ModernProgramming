...
class TFraction: TData {
    ...
    override fun square(): TFraction{
        return TFraction(numerator*numerator, denominator*denominator)
    }

    override operator fun plus(operator2: TData): TData{
        var result = TFraction(0,1)
        operator2 as? TFraction ?: return result
        this.reduceFraction()
    ...
    override operator fun minus(operator2: TData): TData{
        var result = TFraction(0,1)
        operator2 as? TFraction ?: return result
        this.reduceFraction()
        operator2.reduceFraction()
    ...
    override operator fun times(operator2: TData): TData{
        var result = TFraction(0,1)
        operator2 as? TFraction ?: return result
        this.reduceFraction()
        operator2.reduceFraction()
    ...
    override operator fun div(operator2: TData): TData{
        var result = TFraction(0,1)
        operator2 as? TFraction ?: return result
        this.reduceFraction()
        operator2.reduceFraction()
